        ...
        <div style={{ maxWidth: '900px', margin: '0 auto' }}>
          ...
          <div style={{
            ...
            <p style={{ 
              ...
              This guide is for general information only and is not medical advice. Always follow the instructions from your treatment provider. Recovery times can vary from person to person. Verify provider credentials independently before scheduling treatments.
            </p>
          </div>
        </div>
      </Layout>
